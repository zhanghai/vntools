    ...
    val lineOrLines: Any? = when (descriptor.name) {
        ...
        "setForeground" -> {
            ...
            ElementLine(
                ...
                "scaleY" to scale,
                "pivotX" to "50%",
                "x" to getParameter<Short>("centerX").toString(),
                "y" to getParameter<Short>("top").toString()
            )
        }
        "showImages" -> {
            ...
            if (transitionDuration > 1) {
                imageElementNames.map {
                    ElementLine(it, "transition_duration" to transitionDuration.toString())
        ...
        "fadeOutMusic" ->
            ElementLine(
                "music",
                "none",
                "transition_duration" to getParameter<UShort>("duration").toString()
            )
        "playMusicWithFadeIn" ->
            ElementLine(
                "music",
        ...
        "playSpecialEffect" -> CommentLine(toString())
        "stopSpecialEffect" -> CommentLine(toString())
        ...
        "setForegroundAnimationStart" -> {
            ...
            val properties = listOfNotNull(
                ...
                "x" to getParameter<Short>("centerX").toString(),
                "y" to getParameter<Short>("top").toString(),
                "scaleX" to "${getParameter<UByte>("scaleX")}%",
                "scaleY" to "${getParameter<UByte>("scaleY")}%",
        ...
        "decreaseMusicVolume", "increaseMusicVolume" -> {
            ...
            if (duration > 1) {
                ElementLine(
                    "music",
                    "volume" to volume,
                    "transition_duration" to duration.toString()
                )
            } else {
    ...
    val outputText = buildString {
        appendLine(
            """
                ...
                height: 720
                blank_line:
                  - ': wait "character, text, voice"'
                  - ': snap "character, text, voice"'
                  - ': pause'
                  - 'character: ""'
                  - 'text: ""'
                  - : snap "character, text"
